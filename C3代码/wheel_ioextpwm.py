...
# 速度对应的pwm值
speed_levels_dic = [{'pos':1, 'pwm':255}, {'pos':1, 'pwm':500}, {'pos':1, 'pwm':750},
                    {'pos':1, 'pwm':1023}, {'pos':2, 'pwm':600}, {'pos':2, 'pwm':700},
                    {'pos':2, 'pwm':800}, {'pos':2, 'pwm':900}, {'pos':2, 'pwm':1000},
                    {'pos':2, 'pwm':1023}]
        ...
        if old_move_state != self.move_state:
            if self.move_state == 1:
                ...
                if cur_sensor_dis < CAR_STOP_DIS:
                    ...
                    self.sensor_timer.init(period=100, mode=Timer.PERIODIC, callback=self.sensor_timer)
                    # 计算一次更新频率
